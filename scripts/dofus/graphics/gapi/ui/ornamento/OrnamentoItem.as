...
if(!dofus["\r\x13"].gapi.ui.ornamento)
{
   _global.dofus["\r\x13"].gapi.ui.ornamento = new Object();
}
_global.dofus["\r\x13"].gapi.ui.ornamento.OrnamentoItem = function()
{
   super();
};
_global.dofus["\r\x13"].gapi.ui.ornamento.OrnamentoItem.prototype = new dofus["\r\x13"].gapi.core["\x10\x18"]();
var _loc1 = _global.dofus["\r\x13"].gapi.ui.ornamento.OrnamentoItem.prototype;
